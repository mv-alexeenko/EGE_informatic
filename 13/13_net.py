...
# Все функции библиотеки возвращают объект формата ipaddress.IPv4Address, но он легко
# конвертируется в другие типы.
from ipaddress import *  # Для удобства подачи материала я импортирую библиотеку здесь
